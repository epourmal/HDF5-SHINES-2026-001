...
The strategic root-cause categories are tighter than the CVE count
...
\caption{Strategic root-cause categories in the HDF5 CVE history}
...
\caption[]{Strategic root-cause categories in the HDF5 CVE history, continued}\\
\hline
\textbf{Root-cause category} & \textbf{What it means for HDF5} \\
\hline
\endhead
